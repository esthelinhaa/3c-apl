...
var cxPerguntas= document.querySelector("cx-principal");
var cxAlternativas= document.querySelector("cx-principal");
var cxResultado= document.querySelector("cx-principal");
var txResultado= document.querySelector("cx-principal");
var perguntas=[
    {
